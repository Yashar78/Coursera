...
def mapReduce(f: Int => Int, combine:(Int, Int)=> Int, zero:Int)(a:Int, b:Int): Int=
  ...
  def product(f: Int => Int)(a: Int, b:Int): Int = mapReduce(x => x, (x,y)=> x* y , 1)(a,b);System.out.println("""product: (f: Int => Int)(a: Int, b: Int)Int""");$skip(22); val res$0 = 
  product(x=>x)(1, 5);System.out.println("""res0: Int = """ + $show(res$0));$skip(49); 
  def fact(n: Int): Int =
  	product(x =>x)(1,n);System.out.println("""fact: (n: Int)Int""");$skip(13); val res$1 = 
