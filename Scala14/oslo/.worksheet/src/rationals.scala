...
object  rationals {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(49); 
  ...
  -x;System.out.println("""res1: Rational = """ + $show(res$1));$skip(28); 
  val y = new Rational(5,7);System.out.println("""y  : Rational = """ + $show(y ));$skip(44); 
  val z = new Rational(323232321,600000000);System.out.println("""z  : Rational = """ + $show(z ));$skip(16); val res$2 = 
  ...
  x max y;System.out.println("""res4: Rational = """ + $show(res$4));$skip(20); val res$5 = 
  new Rational(1,1);System.out.println("""res5: Rational = """ + $show(res$5));$skip(18); val res$6 = 
  new Rational(4);System.out.println("""res6: Rational = """ + $show(res$6));$skip(8); val res$7 = 

	x * y
	type Set = Int => Boolean;System.out.println("""res7: Rational = """ + $show(res$7));$skip(80); 
