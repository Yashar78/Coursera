...
object testSheet {
  ...
  size(set5.filter(tw => tw.retweets == 20))      //> res1: Int = 0
   ...
   val ll = set5.descendingByRetweet              //> ll  : objsets.TweetList = objsets.Cons@502cb49d
  ...
  val x1 = new Empty                              //> x1  : objsets.Empty = .
  x1.incl(new Tweet("h","b", 1))                  //> res7: objsets.TweetSet = {.User: h
                                                  //| Text: b [1].}
  val x2 = new Empty                              //> x2  : objsets.Empty = .
  x2.incl(new Tweet("h","a", 2))                  //> res8: objsets.TweetSet = {.User: h
                                                  //| Text: a [2].}
  
  x1.union(x2)                                    //> res9: objsets.TweetSet = .
